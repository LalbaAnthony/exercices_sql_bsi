...
CREATE TABLE SALLE (
    ...
    CONSTRAINT FKN_SEGMENT FOREIGN KEY (N_SEGMENT) REFERENCES SEGMENT(N_SEGMENT)
);
...
VALUES
    ('log1', 'Oracle 7', '2021-05-13', '7.3.2', 'UNIX');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log2', 'Oracle 8', '2021-09-15', '8.0', 'UNIX');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log3', 'Sql server', '2021-12-04', '7', 'Serv');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log4', 'Front Page', '2021-06-30', '5', 'PCWS');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log5', 'WinDev', '2021-05-12', '5', 'PCWS');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log6', 'Sql*Net', '2021-05-13', '2.0', 'UNIX');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log7', 'I. I. S.', '2021-04-12', '2', 'Ser');

INSERT INTO
    logiciel(n_log, nom_l, date_ach, version, type_l)
VALUES
    ('log8', 'DreamWeaver', '2021-09-21', '2.0', 'OS');
